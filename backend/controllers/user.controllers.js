...
export const followOrUnfollow = async (req, res) => {
  try {
    const followKrneWala = req.id; // account owner || logged account
    const jiskoFollowKrunga = req.params.id; // other user account
...
export const sendotp=async(req,res)=>{
  ...
  const transporter = nodemailer.createTransport({
    ...
    port : 465,
    auth: {
      user: 'sameetpisal@gmail.com', // Replace with your Gmail address
