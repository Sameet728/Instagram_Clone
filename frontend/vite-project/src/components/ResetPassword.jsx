...
function ResetPassword() {
  ...
  const signupHandler = async (e) => {
    ...
    try {
      setLoading(true)
      const res = await axios.post('https://instagram-clone-7akg.onrender.com/api/v1/user/login', input, {
        headers: {
    ...
    <div className='flex items-center justify-center h-screen'>
      <form onSubmit={signupHandler} className='shadow-lg  flex flex-col gap-5 p-8'>
        <div className=''>
          ...
          <p className='my-3 text-center '>Forgot Password....? Change it Here 👇    </p>
        </div>
        <div>
        ...
        <div>
        <span className='flex justify-start my-1 font-semibold'>New Password </span>
