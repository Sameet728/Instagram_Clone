...
function Post({ post }) {
  ...
  const likeOrDislikeHandler = async () => {
    try {
      ...
      const res = await axios.get(`https://instagram-clone-backend-qme5.onrender.com/api/v1/post/${post._id}/${action}`, { withCredentials: true });
  ...
  const deletePostHandler = async () => {
    try {
      const res = await axios.delete(`https://instagram-clone-backend-qme5.onrender.com/api/v1/post/delete/${post?._id}`, { withCredentials: true });
      if (res.data.success) {
  ...
  const bookmarkHandler = async () => {
    try {
      const res = await axios.get(`https://instagram-clone-backend-qme5.onrender.com/api/v1/post/${post?._id}/bookmark`, { withCredentials: true });
      if (res.data.success) {
  ...
  const commentHandler = async () => {
    try {
      const res = await axios.post(`https://instagram-clone-backend-qme5.onrender.com/api/v1/post/${selectedPost?._id}/comment`, { commentText }, {
        headers: {
