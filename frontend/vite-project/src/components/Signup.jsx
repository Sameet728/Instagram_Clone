...
function Signup() {
  ...
  const signupHandler=async(e)=>{
    ...
    try {
      setLoading(true)
      const res= await axios.post('https://instagram-clone-7akg.onrender.com/api/v1/user/register',input,{
        headers:{
  ...
  const OtpwindowHanlder=async()=>{
    try {
      ...
      const res = await axios.post(
        'https://instagram-clone-7akg.onrender.com/api/v1/user/send-otp',
